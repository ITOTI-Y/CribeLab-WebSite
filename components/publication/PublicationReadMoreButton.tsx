...
export default function PublicationReadMoreButton({ href, text }: ReadMoreButtonProps) {
    return (
        <Link
            href={href}
            ...
            px-2 py-2 overflow-hidden border-1 rounded-full group bg-white text-black">
            {text || "Read More"}
            <div className="flex w-5 h-5 justify-center items-center border-1 rounded-full 
