...
export default async function TeamSection() {
    ...
    const citation = "Highly Skilled Professionals, Green Building Design Research Backgrounds in Architecture & Building Science with Industry and Academic Experience including computational and Practical expertise"
